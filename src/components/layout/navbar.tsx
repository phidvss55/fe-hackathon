...
const Navbar: React.FunctionComponent<Props> = (props) => {
  ...
  const navList = (
    ...
    >
      {props.routes.map(({ name, path, icon }: any) => (
        <Typography
          key={name}
          as={"li"}
          variant={"small"}
    ...
    <MTNavbar className={"p-3"}>
      ...
      >
        ...
        <IconButton
          ...
          size={"sm"}
          className={
            "ml-auto text-inherit hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden"
          }
